...
data class MyRunAttempts(
    ...
    @Relationship("run")
    @JvmField
    val run: MyCourseRuns? = null
) : BaseModel()

@Type("run_attempt")
@JsonNaming(PropertyNamingStrategy.KebabCaseStrategy::class)
data class MyRunAttempt(
    @JvmField
    var certificateApproved: Boolean = false,
    @JvmField
    var end: String,
...
data class MyCourseRuns(
    ...
    @Relationship("course")
    @JvmField
    val course: MyCourse? = null,
    @Relationship("run-attempts")
    @JvmField
    val runAttempts: ArrayList<MyRunAttempts>? = null,
    @Relationship("sections")
    @JvmField
    val sections: ArrayList<CourseSection>? = null,
...
@Type("content", path = "/api/v2/sections/{id}/relationships/contents")
